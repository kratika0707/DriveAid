          ...
          services.map(service => (
            ...
            >
              ...
              <div className="card-body" style={{ textAlign: 'left', marginLeft: '20px' }}>
                ...
                <Link to={`/dealer/notifications/${authState.dealerId}/dealer/service/${service._id}`} className="btn " style={{ padding: '10px 15px', borderRadius:'20px', backgroundColor:'#ea422b',color:'white', fontWeight:'500'}}>View details</Link>
              </div>
            </div>
          ))
        ) : (
