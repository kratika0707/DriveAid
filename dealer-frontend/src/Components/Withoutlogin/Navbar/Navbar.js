                    ...
                    {authState.isAuthenticated && (
                        <>
                            <nav className="navbar navbar-expand-lg " style={{backgroundColor:'black', }}>
                                <div className="container-fluid">
                                    <Link className="navbar-brand" to={`/`} style={{ fontWeight: '800', fontSize: '2rem', color: 'white', letterSpacing: '0.075rem' }}>
                                        DriveAid
                                    </Link>
                                    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                                        <span className="navbar-toggler-icon"></span>
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div className="navbar-nav ms-auto d-flex align-items-center">
        ...
        <Link className="nav-link" to={`/mechanic/notifications/${mechauthState.mechanicId}`} style={{ position: 'relative', marginRight: '20px' }}>
          <FaBell size={24} style={{ color: 'white' }} />
          {unreadCount > 0 && (
            <span style={{
              position: 'absolute',
              top: '-10px',
        ...
        <div className="nav-link dropdown" style={{}}>
          <i
            className="bi bi-person-circle profile-icon"
            id="dropdownMenuButton"
            data-bs-toggle="dropdown"
