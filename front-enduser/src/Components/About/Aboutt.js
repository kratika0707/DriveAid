          ...
          <div style={{marginLeft:'2%', marginRight:'2%'}}>
            <div className="row align-items-center">
              <div className="col-md-6 padding-medium pe-5 border-end">
                ...
                <p className="header-top mb-3" style={{color:'#0078d6', fontWeight:'700'}}>Why choose us</p>
              ...
              <div className="col-md-6 padding-medium-2 ps-md-5">
                ...
                <a href="/about" className="btn  ms-5 mt-3" style={{backgroundColor:'#0078d6', color:'white', fontSize:'1.25rem',fontWeight:'500', padding:'10px 25px' }}>
                  ABOUT US
